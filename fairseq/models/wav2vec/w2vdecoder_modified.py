...
@register_model("w2vdecoder_modified")
class Wav2VecdecoderModel(BaseFairseqModel):
    @staticmethod
    def add_args(parser):
    ...
    def build_model(cls, args, task):
        ...
        model = Wav2VecdecoderModel(args)
        logger.info(model)
        return model
    ...
    def forward(self, source):
        ...
        features = self.feature_aggregator(source)
...
class ConvFeatureExtractionModel(nn.Module):
    def __init__(
        ...
        in_d = 512 # in_dim of embedding dim
...
@register_model_architecture("w2vdecoder_modified", "w2vdecoder_modified")
