...
@register_model_architecture("w2vdecoder", "w2vdecoder")
def base_wav2vec_architecture(args):
    ...
    args.skip_connections_feat = getattr(args, "skip_connections_feat", True)
    args.skip_connections_agg = getattr(args, "skip_connections_agg", True)
    ...
    args.activation = getattr(args, "activation", "tanh")
