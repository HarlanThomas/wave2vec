...
@register_task("decoder_training")
class AudioPretrainingTask__(LegacyFairseqTask):
    """"""
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default=None,
            help="file path of decoder's label audio data",
        )
    def __init__(self, args, source_dictionary=None, target_dictionary=None):
        ...
        print('**********Here is decoder training', self.label_path)
